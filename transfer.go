...
import (
	...
	"github.com/NikkDev0/http/httptrace"
	"github.com/NikkDev0/http/internal"
...
func (t *transferWriter) writeHeader(w io.Writer, trace *httptrace.ClientTrace) error {
	...
	// Transfer-Encoding whose values are a function of the sanitized field triple (Body, ContentLength, TransferEncoding)
	if chunked(t.TransferEncoding) {
